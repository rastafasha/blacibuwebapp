...
@Component({
  selector: 'app-recertificacion',
  templateUrl: './recertificacion.component.html',
  styleUrls: ['./recertificacion.component.css'],
  providers: [UserService, TipoRegistroService, TranslateService]
})
export class RecertificacionComponent implements OnInit {
